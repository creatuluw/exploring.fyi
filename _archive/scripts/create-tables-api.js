...
async function createTablesViaAPI() {
  try {
    ...
    const createParagraphProgressTable = `
    ...
    const tables = [
      ...
      { name: 'paragraph_progress', sql: createParagraphProgressTable },
      { name: 'paragraph_qa', sql: createParagraphQATable }
    ];
...
async function testTableAccess() {
  ...
  console.log('\n🎉 If paragraph_progress and paragraph_qa are accessible,');
  console.log('    the paragraph-based learning features are ready to use!');
}
