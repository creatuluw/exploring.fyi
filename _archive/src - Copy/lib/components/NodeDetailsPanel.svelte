	...
	{#if nodeData}
		<div class="space-y-6">
			...
			{#if nodeData.subConcepts && nodeData.subConcepts.length > 0}
				<div>
					<h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3 flex items-center">
				...
				<div>
					...
					<div class="space-y-2">
						{#each nodeData.sources as source}
							...
							>
								<div class="flex-1">
									<h5 class="font-medium text-gray-900 dark:text-gray-100 group-hover:text-blue-600">
										{source.title}
									</h5>
								...
								<ExternalLink class="w-4 h-4 text-gray-400 group-hover:text-blue-600" />
							</a>
						{/each}
					</div>
				</div>
			...
			<div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
				...
				<div class="flex gap-3">
					...
					<button 
						type="button"
						class="px-4 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors text-sm font-medium"
