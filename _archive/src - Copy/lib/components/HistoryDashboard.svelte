<script lang="ts">
	...
	import { Clock, Brain, TrendingUp, BookOpen, ExternalLink, RotateCcw, ChevronLeft, ChevronRight, MoreVertical } from 'lucide-svelte';
	...
	async function viewTopicDetails(topicId: string) {
		// Navigate to topic content page using just the ID
